...
export class BusticketService {
  ...
  userdelete(formdata):Observable<any>{
    ...
    return this.http.put('https://busbookingnode.herokuapp.com/userdelete',formdata);
  ...
  updateprofile(formdata):Observable<any>{
    ...
    return this.http.put('https://busbookingnode.herokuapp.com/updateprofile',formdata);
  ...
  get_user_id(formdata):Observable<any>{
    ...
    return this.http.post('https://busbookingnode.herokuapp.com/getuserid',formdata);
  }

  usersignup(formdata):Observable<any>{
    // console.log('usersignup method');
    // return this.http.post('http://localhost:3040/signup',formdata);
    return this.http.post('https://busbookingnode.herokuapp.com/signup',formdata);
  }

  user_sign_in(formdata):Observable<any>{
    // console.log('login method');
    // return this.http.post('http://localhost:3040/signin',formdata);
    return this.http.post('https://busbookingnode.herokuapp.com/signin',formdata);
  }
  ...
  get_user_data(data):Observable<any>{
    ...
    return this.http.get('https://busbookingnode.herokuapp.com/getuserdata/'+data);
  }
   ...
   postBus(data):Observable<any>{
    ...
    //  return this.http.post('http://localhost:3040/addbus',data);
     return this.http.post('https://busbookingnode.herokuapp.com/addbus',data);
   }
  ...
  findbusone(data):Observable<any>{
    ...
    return this.http.get('https://busbookingnode.herokuapp.com/getbusdata/'+data);
  }
  ...
  addticket(data):Observable<any>{
    ...
    return this.http.post('https://busbookingnode.herokuapp.com/addticket',data);
  }
  ...
  addTickettoUser(data):Observable<any>{
    ...
    return this.http.put('https://busbookingnode.herokuapp.com/userticket',data);
  }
  ...
  updateSeats(data):Observable<any>{
    ...
    return this.http.put('https://busbookingnode.herokuapp.com/updateseats',data);
  }

  cancelTicket(userid,ticketid):Observable<any>{
    ...
    return this.http.put('https://busbookingnode.herokuapp.com/cancelticket',obj);
  }

  Ticketdb(ticketid):Observable<any>{
    ...
    return this.http.put('https://busbookingnode.herokuapp.com/cancelticketfromdb',obj);
  }
  ...
  addbustoOp(idandbusid):Observable<any>{
    ...
    return this.http.put('https://busbookingnode.herokuapp.com/addbustooperator',idandbusid);
  }
  ...
  findbusofoperator(id):Observable<any>{
    ...
    return this.http.get('https://busbookingnode.herokuapp.com/findbusofoperator/'+id);
  }
}
