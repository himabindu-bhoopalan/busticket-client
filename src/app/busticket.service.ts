...
export class BusticketService {
  ...
  get_user_data(data):Observable<any>{
   ...
   buslistapproved():Observable<any>{
    console.log('bus list approved service');
   
    return this.http.get('https://busnode.herokuapp.com/allbusesapproved');
  }
  ...
  addTickettoUser(data):Observable<any>{
    console.log('inside add tikcet to user db')
...
//  buslistapproved():Observable<any>{
//   console.log('bus list approved service');
//   return this.http.get('http://localhost:3040/allbusesapproved');
//   // return this.http.get('https://busnode.herokuapp.com/allbusesapproved');
// }
//  busoplist():Observable<any>{
//   console.log('bus op list service');
